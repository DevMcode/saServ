...
if ($tipo == "Personas")
  {
              ...
              if (mysql_num_rows($hconsulta)>0)
              {
                ?>
                                  ...
                                  window.location="http://managercode.com/es/cuentaregistrada/";
                                  </script>
               <?php 
              }
              else
              {
                ...
                Sr(a). '.$_POST['nombres'].', es un gusto para nosotros que usted forme parte de nuestra cartera de clientes. Su usuario y su password para acceer a su cuenta son los siguientes:
                 ...
                 Usted puede cambiar su contraseña cuando guste desde su cuenta en la pestaña editar perfil.        
                  ...
                  De igual forma lo invitamos a visitar nuestra pagina web www.managercode.com donde con su usuario y su contrasena, usted podra monitorear el estatus de sus facturas, pagos y servicios.
                    ...
                    $para2= $_POST['emailPersonas'];
                      ...
                      mail ($para2, $asunto2, $mensaje2, $cabeceras2);   
                        ...
                        ?>
                                              <script type="text/javascript">
                                              window.location="http://managercode.com/es/registrosuccessfull/";
                                              </script>
                            <?php 
          ...
          elseif ($tipo == 'Empresas')
          {
              ...
              if (mysql_num_rows($hconsulta)>0)
              {
                ...
                ?>
                                  <script type="text/javascript">
                                  window.location="http://managercode.com/es/cuentaregistradae/";
                                  </script>
               <?php 
              }
              else
