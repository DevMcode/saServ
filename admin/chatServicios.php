  ...
  <?php 
    if (isset($_POST['completado'])){
      ...
      require ("../cnx.php"); 
                ...
                $from = 'info@managercode.com';
                $headers = "From:" . $from; 
                $message='Reporte de servicio completado
        
                Se ha recibido una notificacion de servicio a clientes completado.

                 por favor verifique desde el modulo administrador los detalles de esta gestion.
...
<?php
 if(isset($_POST['seguir']))
 {
  ...
  <?php
                ...
                if($cliente!="Systems Admins")
                {

                  $idTecnico = intval(preg_replace('/[^0-9]+/', '', $tecnico), 10);
                  require("../cnx.php");
                  $ssql     = mysql_query("SELECT * FROM administradores WHERE idAdmin='$cliente'");      
