...
if(isset($_POST['submit']))
			{
				...
				echo "<br><br>";
                  ...
                  $emailTecnico = mysql_result($ssql,0,"email");
                      ...
                      $to2 = $emailTecnico;
                      $subject2 = 'Pago Abonado';          
                      $from2 = 'info@mangaercode.com';
                      $headers2 = "From:" . $from2; 
                      $message2 ='
                      

                      Se ha realizado un pago por concepto de servicios prestados. 

                      Por favor ingrese en www.managercode.com/areacliente con su cuenta  para conocer los detalles de la transaccion.
...
?>
			...
			<div style="background-color: none; width: 100%;  display: inline-block; margin-top: 10px;">
				...
				<input type="submit" name="submit" value="Pagar Servicio">
