...
<script type="text/javascript">
    setTimeout(function(){window.location="home.php"},120000);
</script>
<body>
...
<?php
  if(isset($_POST['crearTicket2'])){
    ...
    date_default_timezone_set('America/La_Paz');
       ...
       if($admin!="Systems Admins")
                {

                  $idTecnico = intval(preg_replace('/[^0-9]+/', '', $admin), 10);
                  require("../cnx.php");
                  $ssql     = mysql_query("SELECT * FROM administradores WHERE idAdmin='$admin'");      
                  $emailTecnico = mysql_result($ssql,0,"email");
                  echo $emailTecnico;


                      $to = $emailTecnico;
                      $subject = 'Ticket de Servicio';          
                      $from = 'info@mangaercode.com';
                      $headers = "From:" . $from; 
                      $message ='
                      

                      Ha recibido una solicitud de Servicios. 

                      Por favor ingrese en www.managercode.com/areacliente con su cuenta Tecnico para conocer los detalles del servicio solicitado.
                  ...
                  echo $emailCliente;
                      ...
                      $to2 = $emailCliente;
                      $subject2 = 'Ticket de Servicio';          
                      $from2 = 'info@mangaercode.com';
                      $headers2 = "From:" . $from2; 
                      $message2 ='
                      

                      Ha sido cargado un ticket de servicio a su cuenta Cliente. 

                      Por favor ingrese en www.managercode.com/areacliente con su cuenta para conocer los detalles del servicio.
