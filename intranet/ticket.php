...
<div style="background-color: rgba(000, 0, 0, 0.5); width: 100%; display: inline-block; vertical-align: top; padding-left: 80px; color:white; text-align: center;">TICKETS DE SERVICIOS
	...
	<div>
		<a href="home.php"><img src="img/arrowWhite.png" width="30px;" height="30px;" ></a>
	</div>
...
<!---------------------------------DATOS DEL TICKET---------------------------------------->					                                   
					...
					<div style="margin: 50px 0 0 30px; text-align: center;">
					  ...
					  <h4 style="color: #ccc;">Tipo de Servicio: <font color="#63be33"><?php echo $area; ?></font></h4> 

					  <h4 style="color: #ccc;">Asunto de Servicio: <font color="#63be33"><?php echo $asunto; ?></font></h4> 
					  
					  <h4 style="color: #ccc;">Descripción: <font color="#63be33"><?php echo $mensaje; ?></font></h4>

					  <h4 style="color: #ccc;">Cliente: <font color="#63be33"><?php echo $clienteName; ?></font></h4>

					  <h4 style="color: #ccc;">Asignado a: <font color="#63be33"><?php echo $admin; ?></font></h4>
