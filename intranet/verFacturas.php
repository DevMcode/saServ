      ...
      $hacerconsulta  = mysql_query ($consultaUpdate);
              ...
              //-------------------ENVIO DE EMAIL
                  ...
                  $emailCliente = mysql_result($ssql,0,"email");
                      ...
                      $to2 = $emailCliente;
                      $subject2 = 'Confirmacion de Pago';          
                      $from2 = 'info@mangaercode.com';
                      $headers2 = "From:" . $from2; 
                      $message2 ='
                      

                      Se ha confirmado el pago realizado. 

                      Por favor ingrese en www.managercode.com/areacliente con su cuenta  para conocer los detalles de la transaccion y descargar las facturas de servicios.
                      ...
                      $hacerconsulta=mysql_query ($consulta,$conexion);
                        ...
                        echo "<td class='dark' align='center' style='border: inset 0pt'>        
                          <form action='#' method='post'>      
                            ...
                            <input type='hidden' name='cliente2' value=".$reg[2].">
